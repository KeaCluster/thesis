...
% 
%El estilo de las referencias puede cambiar pero eso no afectará su proyecto
...
%	\color{azulUC3M}
	\begin{figure}
         \centering
          \subfloat{
            \includegraphics[width=0.5\textwidth]{upa.jpg}}
          \subfloat{
            \includegraphics[width=0.5\textwidth]{logo_UC3M.png}}
         
         \label{f:animales}
    \end{figure}
	\begin{center}
	%	\begin{figure}[H] %incluimos el logotipo de la Universidad
	%		\makebox[\textwidth][c]{\includegraphics[width=10cm]{imagenes/upa.jpg}}
	%	\end{figure}
		\vspace{2.5cm}
		\begin{Large}
			Reporte Final de Estadías \\Enero - Abril 2021\\			
			 %2020-2021\\ %Indica el curso académico
			\vspace{2cm}		
			%\textsl{Reporte de Estadías}
			\bigskip
